...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub Find(SciRef As ScintillaField, Pattern As String = "")
		  Me.SciRef = SciRef
	...
	#tag Property, Flags = &h21
		Private SciRef As Scintilla.ScintillaField
	#tag EndProperty
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  Dim i As Integer = SciRef.Search.Find(TextField1.Text)
		  If i > -1 Then
		    SciRef.ScrollToPosition(i)
		  Else
