#tag Window
Begin ContainerControl StyleEdit
   AcceptFocus     =   ""
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   &hFFFFFF
...
#tag WindowCode
	#tag Event
		Sub Open()
		  textSize.ListIndex = GetReference.Style(CurrentStyle).TextSize - 9
		  Dim f As String = GetReference.Style(CurrentStyle).TextFont.Trim
...
#tag Events Oval1
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  me.FillColor = c
		  GetReference.Style(CurrentStyle).TextColor = c
	...
	#tag Event
		Sub Change()
		  If Me.ListIndex >= 1 Then
		    GetReference.Style(CurrentStyle).TextFont = Me.Text
...
#tag Events Oval2
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  Call SelectColor(c, "Choose a Color")
		  me.FillColor = c
		  GetReference.Style(CurrentStyle).Background = c
...
#tag Events CheckBox1
	#tag Event
		Sub Action()
		  GetReference.Style(CurrentStyle).Bold = Me.Value
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckBox2
	#tag Event
		Sub Action()
		  GetReference.Style(CurrentStyle).Italic = Me.Value
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckBox3
	#tag Event
		Sub Action()
		  GetReference.Style(CurrentStyle).Underline = Me.Value
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events textSize1
	#tag Event
		Sub Open()
		  'Me.AddRow("Size")
		  'Me.ListIndex = 0
